...
/* Command for C compiler:
   clang -c  -w -ferror-limit=3   -I/data/data/com.termux/files/usr/lib/nim/lib -I/data/data/com.termux/files/home/ngfx/generator -o /data/data/com.termux/files/home/ngfx/generator/cache/stdlib_digitsutils.nim.c.o /data/data/com.termux/files/home/ngfx/generator/cache/stdlib_digitsutils.nim.c */
...
static N_INLINE(void, addChars__stdZprivateZdigitsutils_100)(NimStringDesc** result, tyArray__PbS9a6gkxCuxWEnFq4lOU9aw x, NI start, NI n) {
	...
	nimfr_("addChars", "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	nimln_(43, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	old = ((*result) ? (*result)->Sup.len : 0);
	nimln_(44, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	...
	nimln_(52, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
...
static N_INLINE(void, addIntImpl__stdZprivateZdigitsutils_59)(NimStringDesc** result, NU64 x) {
	...
	nimfr_("addIntImpl", "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	nimln_(59, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	num = x;
	nimln_(60, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	next = ((NI) 23);
	{
		nimln_(63, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		while (1) {
			NU64 originNum;
			NU64 index;
			...
			nimln_(64, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			originNum = num;
			nimln_(65, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			num = (NU64)((NU64)(num) / (NU64)(100ULL));
			nimln_(66, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			index = (NU64)((NU64)((NU64)((NU64)(originNum) - (NU64)((NU64)((NU64)(num) * (NU64)(100ULL))))) << (NU64)(((NI) 1)));
			if ((NU)(next) > (NU)(23)){ raiseIndexError2(next, 23); }
			nimln_(67, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			...
			nimln_(68, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			...
			nimln_(69, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			if (nimSubInt(next, ((NI) 2), &TM__J7BLF9cgvwzEso7aEL9cCOKw_4)) { raiseOverflow(); };
			next = (NI)(TM__J7BLF9cgvwzEso7aEL9cCOKw_4);
		} LA2: ;
	}
	nimln_(72, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	{
		if (!((NU64)(num) < (NU64)(10ULL))) goto LA5_;
		if ((NU)(next) > (NU)(23)){ raiseIndexError2(next, 23); }
		nimln_(73, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	...
	LA5_: ;
	{
		...
		nimln_(75, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		index_2 = (NU64)((NU64)(num) * (NU64)(2ULL));
		if ((NU)(next) > (NU)(23)){ raiseIndexError2(next, 23); }
		nimln_(76, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		...
		nimln_(77, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		...
		nimln_(78, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		if (nimSubInt(next, ((NI) 1), &TM__J7BLF9cgvwzEso7aEL9cCOKw_6)) { raiseOverflow(); };
		next = (NI)(TM__J7BLF9cgvwzEso7aEL9cCOKw_6);
	}
	LA3_: ;
	nimln_(79, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, addInt__stdZprivateZdigitsutils_164)(NimStringDesc** result, NU64 x) {
	...
	nimln_(87, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, addInt__stdZprivateZdigitsutils_167)(NimStringDesc** result, NI64 x) {
	...
	nimln_(99, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
	{
		NI baseX60gensym3_;
		NI TM__J7BLF9cgvwzEso7aEL9cCOKw_2;
		if (!(x < IL64(0))) goto LA3_;
		nimln_(100, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		{
			if (!(x == (IL64(-9223372036854775807) - IL64(1)))) goto LA7_;
			nimln_(101, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			numX60gensym3_ = ((NU64) (x));
		}
		goto LA5_;
		LA7_: ;
		{
			nimln_(103, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
			if (x == (IL64(-9223372036854775807) - IL64(1))){ raiseOverflow(); }
			numX60gensym3_ = ((NU64) (-(x)));
		}
		LA5_: ;
		nimln_(104, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		baseX60gensym3_ = ((*result) ? (*result)->Sup.len : 0);
		nimln_(105, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		...
		nimln_(106, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		(*result)->data[baseX60gensym3_] = 45;
	}
	goto LA1_;
	LA3_: ;
	{
		nimln_(108, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
		numX60gensym3_ = ((NU64) (x));
	}
	LA1_: ;
	nimln_(114, "/data/data/com.termux/files/usr/lib/nim/lib/std/private/digitsutils.nim");
